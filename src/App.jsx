...
const Dashboard = ({ activeTab, setActiveTab }) => {
  return (
    <div className="max-w-6xl mx-auto bg-[#1a1a1a]/40 backdrop-blur-xl border-x border-white/5 min-h-screen relative z-10 shadow-[0_0_80px_rgba(0,0,0,0.5)]">
...
function App() {
  ...
  return (
    <div className="min-h-screen bg-[#050505] font-sans selection:bg-white/30 text-white antialiased overflow-x-hidden relative">
      ...
      {/* --- FOOTER OPTIMIZADO PARA ESPACIO --- */}
      <footer className="mt-40 bg-[#050505]/95 backdrop-blur-3xl border-t border-white/10 relative z-20">
        ...
        <div className="max-w-6xl mx-auto px-6 py-16">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
            ...
            {/* 2. DIRECTORIO & REDES (Columna 6/12 - Más ancha para que no salte) */}
